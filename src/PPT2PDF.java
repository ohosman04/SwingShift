...
public class PPT2PDF implements ActionListener{
    ...
    PPT2PDF() {
        ...
        ImageIcon ppt = new ImageIcon("ppt.png");
        ...
        label1.setBounds(440, 250, 100, 100);
        label2.setBounds(170, 250, 100, 100);
    ...
    public void actionPerformed(ActionEvent e) {
           ...
           if (e.getSource() == selectFileButton) {
            ...
            if (file == null) {
                JOptionPane.showMessageDialog(null, "Please select a PPTX file first.");
                return;
            }
            ...
            if (response == JFileChooser.APPROVE_OPTION) {
                ...
                String outputFilePath = new File(destinationFolder, file.getName().replace(".pptx", ".pdf")).getAbsolutePath();
                convertPPTXtoPDF(file, new File(outputFilePath));
                JOptionPane.showMessageDialog(null, "PPTX file converted to PDF successfully.");
            }
        }
        }
        public static void convertPPTXtoPDF(File pptxFile, File pdfFile) {
                    ...
                    if (shape instanceof XSLFTextShape) {
                        ...
                        for (XSLFTextParagraph paragraph : textShape.getTextParagraphs()) {
                            for (XSLFTextRun textRun : paragraph.getTextRuns()) {
                                slideText.append(textRun.getRawText()).append(" ");
                            }
                        }

                        if (slideText.length() > 0) {
                            document.add(new Paragraph(slideText.toString()));
                        }
                    }
                }
            }
            ...
            document.close();
            System.out.println("PPTX to PDF conversion is successful.");

    }   catch (IOException | DocumentException e) {
            e.printStackTrace();
            System.out.println("Error converting PPTX to PDF: " + e.getMessage());
    }   
}
